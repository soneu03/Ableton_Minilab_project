...
class Clip(ModuleType):
    ...
    class Clip(object):
        ...
        def duplicate_region(self, handle, region_start, region_length, destination_time, pitch=-1,
...
class MidiMap(ModuleType):
    ...
    @staticmethod
    def map_midi_cc(midi_map_handle, parameter, midi_channel, controller_number, map_mode, avoid_takeover,
                    sensitivity=1.0):
        """
    ...
    @staticmethod
    def map_midi_cc_with_feedback_map(midi_map_handle, parameter, midi_channel, controller_number, map_mode,
                                      feedback_rule, avoid_takeover, sensitivity=1.0):
        """
